...
class _ProfileInfoScreenState extends State<ProfileInfoScreen> {
  ...
  Future<void> _loadLengthUnit() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      _lengthUnit = prefs.getString('unit_length') ?? 'cm';
    });
  }

  Future<void> _saveAndContinue() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('profile_type', _type);
          ...
          children: [
            Row(
              ...
              children: [
                ...
                CupertinoButton(
                  child: const Text('Готово', style: TextStyle(color: Color(0xFF4C6EF5))),
                  onPressed: () {
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    const Center(
                      child: Text('Заполните информацию',
                    ...
                    _buildMenuCard([
                      _buildPickerTile(
                        label: 'Тип',
                        value: _type,
                        onTap: () => _showOptions('Тип', _types, _type,
                            (val) => setState(() => _type = val)),
                      ),
                      _buildPickerTile(
                        label: 'Пол',
                        value: _gender,
                        onTap: () => _showOptions('Пол', _genders, _gender,
